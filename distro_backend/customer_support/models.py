...
class Customer(models.Model):
    ...
    zone = models.ForeignKey('infrastructure.Zone', on_delete=models.SET_NULL, null=True, blank=True, related_name='customers')
    meter = models.ForeignKey('infrastructure.Meter', on_delete=models.SET_NULL, null=True, blank=True, related_name='customer_connection')
...
class Ticket(models.Model):
    ...
    assigned_to = models.ForeignKey('utilities.User', on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_tickets')
    assigned_at = models.DateTimeField(null=True, blank=True)
    resolved_by = models.ForeignKey('utilities.User', on_delete=models.SET_NULL, null=True, blank=True, related_name='resolved_tickets')
    ...
    created_by = models.ForeignKey('utilities.User', on_delete=models.SET_NULL, null=True, related_name='created_tickets')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class TicketComment(models.Model):
    ...
    created_by = models.ForeignKey('utilities.User', on_delete=models.SET_NULL, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class CustomerNotification(models.Model):
    ...
    zone = models.ForeignKey('infrastructure.Zone', on_delete=models.SET_NULL, null=True, blank=True, help_text="For zone-wide notifications")
...
class ServiceOutage(models.Model):
    ...
    title = models.CharField(max_length=200)
    description = models.TextField()
    affected_zones = models.ManyToManyField('infrastructure.Zone', related_name='outages')
