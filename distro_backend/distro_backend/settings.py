...
PUBLIC_SCHEMA_URLCONF = 'distro_backend.urls_public'
...
# SMS Gateway Configuration (example with Africa's Talking)
SMS_GATEWAY = {
    'PROVIDER': os.getenv('SMS_PROVIDER', 'africastalking'),
    'USERNAME': os.getenv('SMS_USERNAME', 'sandbox'),
    'API_KEY': os.getenv('SMS_API_KEY', ''),
    'SENDER_ID': os.getenv('SMS_SENDER_ID', 'DISTRO'),
}
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@distro.com')
